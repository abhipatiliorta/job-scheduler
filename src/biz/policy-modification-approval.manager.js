    ...
    async policyApproval(event) {
        try {
            ...
            for (const polIndex in updatePlicyArray) {
                ...
                const policyObj = await this.renewalExtractRepository.getModifiedPolicy(policyNo, stage);
                ...
                if (status == 'Accept') {
                    ...
                    const updatePolicy = await this.renewalExtractRepository.updatePolicyData(policyNo, policyObj.TXT_STAGE, updatePolicyObj);
